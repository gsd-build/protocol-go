...
func TestEnvelopeRoundTrip(t *testing.T) {
	cases := []struct {
		...
		{"browserRefs", &BrowserRefs{
			Type:      MsgTypeBrowserRefs,
			BrowserID: "browser_123",
			SessionID: "session_123",
			ChannelID: "channel_123",
			Version:   3,
...
func TestBrowserEnvelopeRejectsInvalidFieldTypes(t *testing.T) {
	cases := []struct {
		...
		{
			name: "browserRefs refs string",
			raw:  `{"type":"browserRefs","browserId":"browser_123","sessionId":"session_123","channelId":"channel_123","version":"v1","refs":"bad","capturedAt":"2026-05-01T12:00:00Z"}`,
		},
		{
...
func TestBrowserEnvelopeIgnoresUnknownFields(t *testing.T) {
	cases := []struct {
		...
		{
			name: "browserRefs",
			raw:  `{"type":"browserRefs","browserId":"browser_123","sessionId":"session_123","channelId":"channel_123","version":3,"refs":[{"ref":"@v3:e1","key":"e1","role":"button","name":"Submit","x":12.5,"y":24.5,"w":80,"h":32}],"capturedAt":"2026-05-01T12:00:00Z","unknown":"ok"}`,
			want: &BrowserRefs{
				Type:      MsgTypeBrowserRefs,
				BrowserID: "browser_123",
				SessionID: "session_123",
